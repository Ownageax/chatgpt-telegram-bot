...
- [x] (NEW!) Support newer models (e.g. `gpt-5`, `gpt-5-mini`, `gpt-5-nano`, `gpt-4.1`, `gpt-4.1-mini`, `o4-mini`) via `OPENAI_MODEL`
...
| `OPENAI_MODEL`                      | The OpenAI model to use for generating responses. Examples: `gpt-5-mini`, `gpt-5`, `gpt-5-nano`, `gpt-5-2025-08-07` (snapshot), `gpt-4.1-mini`, `gpt-4.1`, `gpt-4o`, `gpt-4o-mini`, `o4-mini`. You can find all available models [here](https://platform.openai.com/docs/models/) | `gpt-4o`                           |
...
| `VISION_MODEL`                      | The vision-capable model to use (image understanding). Example: `gpt-4o`                                                                                                                                                                                                                | `gpt-4o`                           |
